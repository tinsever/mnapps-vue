...
const { getMyNewspapers } = useNewspaper();
  ...
  <UContainer class="pt-4">
    <div class="flex gap-12">
      <div class="w-full">
        ...
        <div class="flex justify-between items-center">
          <h1 class="text-4xl font-bold">Zeitungen</h1>
          <!-- 4. Link zum Erstellen anpassen -->
          <ULink to="/mein/zeitungen/create" target="_self">
            <UIcon
    ...
    <div v-if="pending" class="flex justify-center items-center min-h-64">
      <div class="flex flex-col items-center gap-4">
        ...
        <p class="text-gray-600">Lade Zeitungen...</p>
      </div>
    </div>
    ...
    <div v-else class="flex justify-center items-center min-h-64">
      <UCard>
        <div class="flex flex-col items-center gap-4 p-8">
          ...
          <UButton to="/mein/zeitungen/create" icon="i-heroicons-plus">
            Zeitung erstellen
          </UButton>
        </div>
      </UCard>
